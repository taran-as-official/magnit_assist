package dev.fridon.mgntassist.record
...
import dev.fridon.mgntassist.R
import dev.fridon.mgntassist.data.Record
import dev.fridon.mgntassist.databinding.FragmentRecordBinding
import dev.fridon.mgntassist.utils.RecordState
...
class RecordFragment : Fragment(R.layout.fragment_record) {
    ...
    private fun setText(text: String) {
        ...
        val yellow = ForegroundColorSpan(getColor(requireActivity(), R.color.yellow_700))
        ss.setSpan(yellow, 25, finalText.length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
